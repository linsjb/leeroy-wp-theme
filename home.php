...
<div class="o-knowledgeHub col-xs-100">
  <div class="container m-knowledgeHubContent">
    <div id="knowledgeHubPosts" class="m-knowledgeHubLeft col-xs-100 col-md-70">
...
?>
      <div class="m-knowledgeHubPost col-xs-100">
        <div class="a-knowledgeHubPostImage col-xs-100 col-sm-50" style="background-image: url(<?= $postImage->getUrl() ?>)"></div>
        <div class="a-knowledgeHubPostContent col-xs-100 col-sm-50 pull-right">
          <?php
          $postCategory->init();
          ?>
...
?>
  ...
  <div class="m-knowledgeHubRight col-xs-100 col-md-25 pull-right">
