...
?>
  <div class="m-postAuthor col-xs-100 col-sm-100 col-md-100 col-lg-100">
    <img class="a-postAuthor__image col-lg-25" src="<?= $authorAvatar ?>" alt="Author image">
    <div class="m-postAuthorContent col-lg-70 pull-right">
