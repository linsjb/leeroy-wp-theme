...
function leeroyScripts() {
  ...
  wp_enqueue_style( 'flexslider', get_template_directory_uri() . '/dist/css/flexslider.css', array() , '2.7.0', 'all');
  ...
  wp_enqueue_script('leeroyBundle', get_template_directory_uri() . '/dist/js/bundle.js', array('jquery'), '1.0.1', true);
}
